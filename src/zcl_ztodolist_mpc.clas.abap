class ZCL_ZTODOLIST_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_CHANGESTATUS,
        ID type I,
    end of TS_CHANGESTATUS .
  types:
...
TT_TODO type standard table of TS_TODO .
  ...
  constants GC_TODO type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'TODO' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZTODOLIST_MPC=============CP' ##NO_TEXT.
...
CLASS ZCL_ZTODOLIST_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZTODOLIST_SRV' ).
...
lo_action = model->create_action( 'ChangeStatus' ).  "#EC NOTEXT
lo_action->set_label_from_text_element( iv_text_element_symbol = '002' iv_text_element_container = gc_incl_name ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'TODO' ). "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZTODOLIST_MPC=>TS_CHANGESTATUS' ). "#EC NOTEXT
***********************************************************************************************************************************
*   ACTION - GetLastId
***********************************************************************************************************************************

lo_action = model->create_action( 'GetLastId' ).  "#EC NOTEXT
lo_action->set_label_from_text_element( iv_text_element_symbol = '003' iv_text_element_container = gc_incl_name ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'TODO' ). "#EC NOTEXT
*Set HTTP method GET or POST
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'TODO' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Endtime' iv_abap_fieldname = 'ENDTIME' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZITODO'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220611103736'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'TODO'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Endtime'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'TODO'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'ChangeStatus'.                                     "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'GetLastId'.                                     "#EC NOTEXT
ls_text_element-artifact_type          = 'FIMP'.                                               "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'MODL'.                                               "#EC NOTEXT
